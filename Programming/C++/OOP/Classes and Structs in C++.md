...
Use access specifiers to control visibility, constructors to initialize objects and lean on class when you want encapsulation, struct for simple data bundles